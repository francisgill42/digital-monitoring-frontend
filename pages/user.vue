       ...
       <v-dialog v-model="dialog" max-width="500px">
          ...
          <v-card>
            ...
            <v-card-text>
              ...
              <v-row v-if="errors.password">
              <span class="error--text">{{errors.password[0]}}</span>
              </v-row>

              <v-row>
              <v-select v-model="editedItem.role_id" :items="roles" item-value="id" item-text="role" label="User Role"></v-select>
              </v-row>
              
              <v-row v-if="errors.role_id">
              <span class="error--text">The role field is required</span>
              </v-row>
